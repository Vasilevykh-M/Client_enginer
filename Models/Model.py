...
class Metadata:
    def __init__(self, iter, name, metric, weight):
        self.iter = iter
        self.name = name
        self.metric = metric
        self.weight = weight
...
class ModelEngineer:
    ...
    def calc_metrics(self, Y_pred_train, Y_pred_test, Y_train, Y_test, loss_train = 0, loss_test = 0):
        ...
        if loss_train == 0 and loss_test == 0:
            ...
            loss_test = metrics.mean_squared_log_error(Y_test, Y_pred_test)
        cm = metrics.confusion_matrix(Y_test, Y_pred_test)
        return Metric(acc_train, acc_test, f1_train, f1_test, loss_train, loss_test, cm)
